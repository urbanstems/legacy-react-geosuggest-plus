...
var App = React.createClass({
  ...
  onFocus: function onFocus() {
    console.log('onFocus sup'); // eslint-disable-line
  },
    ...
    return (// eslint-disable-line
      React.createElement(
        ...
        React.createElement(Geosuggest, {
          ...
          getRecentLabel: function (recent) {
            return recent.address1 + ', ' + recent.city + ', ' + recent.state_name + ' ' + recent.zipcode;
          },
          radius: '20',
          location: new google.maps.LatLng(38.9047, -77.0164)
        })
      )
    );
  }
...
ReactDOM.render(React.createElement(App, null), document.getElementById('app')); // eslint-disable-line

},{"../../src/Geosuggest":158,"react":157,"react-dom":2}],2:[function(require,module,exports){
'use strict';
...
var Geosuggest = (function (_React$Component) {
  ...
  _createClass(Geosuggest, [{
    ...
    value: function updateSuggests(suggestsGoogle) {
      ...
      // recent/saved
      this.props.fixtures.forEach(function (recent) {
        if (!skipSuggest(recent)) {
          recent.placeId = recent.id;
          recent.altLabel = _this4.props.getRecentLabel(recent);
          recents.push(recent);
        }
      });
    ...
    value: function geocodeSuggest(suggest) {
      ...
      this.geocoder.geocode({ address: suggest.label || suggest.altLabel }, function (results, status) {
...
},{"./GeosuggestItem":159,"react":157}],159:[function(require,module,exports){
/* eslint react/jsx-sort-prop-types: 0, react/sort-comp: 0, react/prop-types: 0 */
'use strict';
...
var GeosuggestItem = (function (_React$Component) {
  ...
  _createClass(GeosuggestItem, [{
    ...
    value: function renderSaved() {
      return _react2['default'].createElement(
        'li',
        { className: this.getSuggestClasses(), onClick: this.onClick.bind(this) },
